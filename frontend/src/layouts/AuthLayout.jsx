...
export function AuthLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-muted">
      ...
      <header className="flex w-full items-center justify-between border-b border-primary/20 bg-primary px-4 py-3 text-primary-foreground">
        <Link
          to="/"
          className="text-xl font-bold tracking-tight focus:outline-none focus:ring-2 focus:ring-primary-foreground/40 focus:ring-offset-2 focus:ring-offset-primary rounded"
        >
          {t("common.brandName")}
        </Link>
